...
const greenPath = ['5','6','7', '1', '3', '11', '4' ,'9' ,'8']
...
const nodeDefaults = {
  ...
  const initialNodes = [
    ...
    // Right side nodes (default)
    {
      id: '2',
      position: { x: -50, y: 250 },
      data: { label: 'L9_PBB_ID already exists'},
      ...nodeDefaults,
      style: {wordWrap: 'break-word', fontSize: 10, textAlign: 'center'}
    },
    {
      ...
      data: { label: 'Prepaid Bucket Creation(L9_PPB_ID)?' },
      ...nodeDefaults,
      style: {wordWrap: 'break-word', fontSize: 10, textAlign: 'center'}
    },
    // {
    ...
    },
    {
      ...
      id: '11',
      position: { x: -50, y: 150 },
      data: { label: 'Create new BILLPAY PCN' },
      style: {wordWrap: 'break-word', fontSize: 10, textAlign: 'center'},
      sourcePosition: Position.Right,
      targetPosition: Position.Left,
      }
  ...
  const initialEdges = [
    ...
    },
    {
        ...
        target: '10',
        type: 'bezier',
        style: { stroke: '#FFDE21', strokeWidth: 2 },
        className: 'node-green-animated'
    },
    // {
    //     id: 'e1-11',
...
const handleClick =  async () => {
  try{
    runFlowAnimation();
  const resp = await fetch('/flow-api/executecrm', {
    method: 'GET',
  }); 
